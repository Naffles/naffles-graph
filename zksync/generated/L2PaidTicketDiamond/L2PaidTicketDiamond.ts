...
export class L2PaidTicketDAIMOND__facetsResultDAIMONDFacetsStruct extends ethereum.Tuple {
  get target(): Address {
    return this[0].toAddress();
  }
...
export class L2PaidTicketDAIMOND extends ethereum.SmartContract {
  static bind(address: Address): L2PaidTicketDAIMOND {
    return new L2PaidTicketDAIMOND("L2PaidTicketDAIMOND", address);
  }
  ...
  facets(): Array<L2PaidTicketDAIMOND__facetsResultDAIMONDFacetsStruct> {
    let result = super.call("facets", "facets():((address,bytes4[])[])", []);

    return result[0].toTupleArray<
      L2PaidTicketDAIMOND__facetsResultDAIMONDFacetsStruct
    >();
  }

  try_facets(): ethereum.CallResult<
    Array<L2PaidTicketDAIMOND__facetsResultDAIMONDFacetsStruct>
  > {
