...
export class Contract__facetsResultDiamondFacetsStruct extends ethereum.Tuple {
  get target(): Address {
    return this[0].toAddress();
  }
...
export class Contract extends ethereum.SmartContract {
  ...
  facets(): Array<Contract__facetsResultDiamondFacetsStruct> {
    let result = super.call("facets", "facets():((address,bytes4[])[])", []);

    return result[0].toTupleArray<Contract__facetsResultDiamondFacetsStruct>();
  }

  try_facets(): ethereum.CallResult<
    Array<Contract__facetsResultDiamondFacetsStruct>
  > {
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<Contract__facetsResultDiamondFacetsStruct>()
    );
  }
