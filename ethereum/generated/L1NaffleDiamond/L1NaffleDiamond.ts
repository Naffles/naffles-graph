...
export class L1NaffleCancelled extends ethereum.Event {
  get params(): L1NaffleCancelled__Params {
    return new L1NaffleCancelled__Params(this);
  }
}

export class L1NaffleCancelled__Params {
  _event: L1NaffleCancelled;

  constructor(event: L1NaffleCancelled) {
    this._event = event;
  }
...
export class L1NaffleCreated extends ethereum.Event {
  get params(): L1NaffleCreated__Params {
    return new L1NaffleCreated__Params(this);
  }
}

export class L1NaffleCreated__Params {
  _event: L1NaffleCreated;

  constructor(event: L1NaffleCreated) {
    this._event = event;
  }
...
export class L1NaffleWinnerSet extends ethereum.Event {
  get params(): L1NaffleWinnerSet__Params {
    return new L1NaffleWinnerSet__Params(this);
  }
}

export class L1NaffleWinnerSet__Params {
  _event: L1NaffleWinnerSet;

  constructor(event: L1NaffleWinnerSet) {
    this._event = event;
  }
...
export class L1NaffleDiamond__facetsResultDiamondFacetsStruct extends ethereum.Tuple {
  get target(): Address {
    return this[0].toAddress();
  }
...
export class L1NaffleDiamond extends ethereum.SmartContract {
  static bind(address: Address): L1NaffleDiamond {
    return new L1NaffleDiamond("L1NaffleDiamond", address);
  }
  ...
  facets(): Array<L1NaffleDiamond__facetsResultDiamondFacetsStruct> {
    let result = super.call("facets", "facets():((address,bytes4[])[])", []);

    return result[0].toTupleArray<
      L1NaffleDiamond__facetsResultDiamondFacetsStruct
    >();
  }

  try_facets(): ethereum.CallResult<
    Array<L1NaffleDiamond__facetsResultDiamondFacetsStruct>
  > {
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<L1NaffleDiamond__facetsResultDiamondFacetsStruct>()
    );
  }
...
export class ConstructorCall__Inputs {
  ...
  get _minimumNaffleDuration(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }

  get _minimumPaidTicketSpots(): BigInt {
    return this._call.inputValues[2].value.toBigInt();
  }

  get _minimumTicketPriceInWei(): BigInt {
    return this._call.inputValues[3].value.toBigInt();
  }

  get _zksyncContractAddress(): Address {
    return this._call.inputValues[4].value.toAddress();
  }

  get _foundersKeyContractAddress(): Address {
    return this._call.inputValues[5].value.toAddress();
  }

  get _foundersKeyPlaceholderAddress(): Address {
