...
export class L1NaffleDAIMOND__facetsResultDAIMONDFacetsStruct extends ethereum.Tuple {
  get target(): Address {
    return this[0].toAddress();
  }
...
export class L1NaffleDAIMOND extends ethereum.SmartContract {
  static bind(address: Address): L1NaffleDAIMOND {
    return new L1NaffleDAIMOND("L1NaffleDAIMOND", address);
  }
  ...
  facets(): Array<L1NaffleDAIMOND__facetsResultDAIMONDFacetsStruct> {
    let result = super.call("facets", "facets():((address,bytes4[])[])", []);

    return result[0].toTupleArray<
      L1NaffleDAIMOND__facetsResultDAIMONDFacetsStruct
    >();
  }

  try_facets(): ethereum.CallResult<
    Array<L1NaffleDAIMOND__facetsResultDAIMONDFacetsStruct>
  > {
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<L1NaffleDAIMOND__facetsResultDAIMONDFacetsStruct>()
    );
  }
